...
const destroy = (id, name) => {
    const c = confirm(`Delete this product ${name}?`);
    if (c) {
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <form @submit.prevent="submit">
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-floating mb-3">
                            <select v-model="form.product_type" class="form-select" id="productTypeSelect">
                                <option value=''>Select Product Type</option>
                                <option v-for="(name, id) in productTypes" :key="id" :value="id">{{ name }}</option>
                            </select>
